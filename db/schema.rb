...
ActiveRecord::Schema[7.0].define(version: 2022_09_21_183856) do
  ...
  create_table "answers", force: :cascade do |t|
    ...
    t.index ["take_id"], name: "index_answers_on_take_id"
  end
